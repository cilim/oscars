RSpec.describe "Admin::DatabaseBackups", type: :request do
  ...
  describe "GET /admin/database_backup/download" do
    it "downloads a full JSON backup including movies" do
      ...
      get download_admin_database_backup_path
  ...
  describe "POST /admin/database_backup/import" do
    it "replaces current data with the uploaded backup" do
      ...
      expect(response).to redirect_to(admin_database_backup_path)
      ...
      expect(Movie.find_by(id: nominee.movie_id)).to have_attributes(
        name: "Anora",
        description: nominee.movie.description,
        imdb_url: nominee.movie.imdb_url
      )
    end
  ...
  describe "as regular user" do
    ...
    it "redirects the backup page to root" do
      get admin_database_backup_path
